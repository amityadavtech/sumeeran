...
const About = () => {
  ...
  return (
    <div className="min-h-screen pt-20" data-testid="about-page">
      ...
      {/* Story Section */}
      <section className="py-16 md:py-24 bg-white" data-testid="story-section">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <ScrollReveal>
              <div className="order-2 lg:order-1">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold mb-6 md:mb-8 text-text-dark leading-tight" data-testid="story-title">
            ...
            <ScrollReveal delay={200}>
              <div className="grid grid-cols-2 gap-3 md:gap-6 order-1 lg:order-2">
                <div className="space-y-3 md:space-y-6">
                  <div className="img-zoom-container rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
                    <img 
                ...
                <ScrollReveal key={item.year} delay={index * 100}>
                  ...
                  >
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300">
                      <div 
                        className="inline-block px-4 py-1 bg-gradient-to-r from-primary to-gold text-white rounded-full text-sm font-bold mb-3"
